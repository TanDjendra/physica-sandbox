import {
  useDrag
} from "./chunk-5CN5DEUC.js";
import {
  require_client
} from "./chunk-SS5PFWJN.js";
...
// node_modules/leva/dist/vector-plugin-5e122f40.esm.js
...
function createSlot(ownerName) {
  const Slot2 = React2.forwardRef((props3, forwardedRef) => {
    let { children, ...slotProps } = props3;
...
function createSlottable(ownerName) {
  const Slottable22 = __name2((props3) => "child" in props3 ? props3.children(props3.child) : props3.children, "Slottable");
...
var getSlottableElementFromSlottable = __name2((slottable, child) => {
...
var createSlotError = __name2((ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
}, "createSlotError");
var createSlottableError = __name2((ownerName) => {
...
var Portal = React5.forwardRef(
  __name4(function Portal2(props3, forwardedRef) {
    var _a;
    const { container: containerProp, ...portalProps } = props3;
    const [mounted, setMounted] = React5.useState(false);
    useLayoutEffect2(() => setMounted(true), []);
    const container = containerProp || mounted && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body);
    return container ? ReactDOM2.createPortal((0, import_jsx_runtime2.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
  }, "Portal")
);
var Root = Portal;
...
function composeEventHandlers(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return __name5(function handleEvent(event) {
...
__name5(composeEventHandlers, "composeEventHandlers");
...
__name5(getOwnerWindow, "getOwnerWindow");
...
__name5(getOwnerDocument, "getOwnerDocument");
...
__name5(getActiveElement, "getActiveElement");
...
function createContext2(rootComponentName, defaultContext) {
  const Context3 = React6.createContext(defaultContext);
  Context3.displayName = rootComponentName + "Context";
  const Provider2 = __name6((props3) => {
    const { children, ...context } = props3;
    const value = React6.useMemo(() => context, Object.values(context));
    return (0, import_jsx_runtime3.jsx)(Context3.Provider, { value, children });
  }, "Provider");
  ...
  __name6(useContext22, "useContext");
  return [Provider2, useContext22];
}
__name6(createContext2, "createContext");
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  __name6(createContext32, "createContext");
  const createScope = __name6(() => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React6.createContext(defaultContext);
    });
    return __name6(function useScope(scope) {
...
__name6(createContextScope, "createContextScope");
function composeContextScopes(...scopes) {
  ...
  const createScope = __name6(() => {
    ...
    return __name6(function useComposedScopes(overrideScopes) {
...
__name7(useCallbackRef, "useCallbackRef");
...
var DismissableLayer = React8.forwardRef(
  ...
  __name8(function DismissableLayer2(props3, forwardedRef) {
    const {
    ...
    React8.useEffect(() => {
      const handleUpdate = __name8(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React8.forwardRef(__name8(function DismissableLayerBranch2(props3, forwardedRef) {
  const context = React8.useContext(DismissableLayerContext);
  ...
  return (0, import_jsx_runtime4.jsx)(Primitive.div, { ...props3, ref: composedRefs });
...
__name8(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = __name8(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React8.useEffect(() => {
    ...
    __name8(resetOutsideInteraction, "resetOutsideInteraction");
    function isOutsideInteractionIntercepted() {
      return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
    }
    __name8(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
    ...
    __name8(handleInteractionCapture, "handleInteractionCapture");
    function handleInteractionBubble(event) {
      if (isPointerDownOutsideRef.current) {
        interceptedOutsideInteractionEventsRef.current.set(event.type, false);
      }
    }
    __name8(handleInteractionBubble, "handleInteractionBubble");
    const handlePointerDown = __name8((event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        __name8(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
  ...
  return {
    ...
    onPointerDownCapture: __name8(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
__name8(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  const handleFocusOutside = useCallbackRef(onFocusOutside);
  const isFocusInsideReactTreeRef = React8.useRef(false);
  React8.useEffect(() => {
    const handleFocus = __name8((event) => {
  ...
  return {
    onFocusCapture: __name8(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name8(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
__name8(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
  const event = new CustomEvent(CONTEXT_UPDATE);
  document.dispatchEvent(event);
}
__name8(dispatchUpdate, "dispatchUpdate");
...
__name8(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
...
var Arrow = React11.forwardRef(
  __name10(function Arrow2(props3, forwardedRef) {
    ...
    return (0, import_jsx_runtime5.jsx)(
      Primitive.svg,
      {
        ...
        children: props3.asChild ? children : (0, import_jsx_runtime5.jsx)("polygon", { points: "0,0 30,0 15,10" })
      }
    );
  }, "Arrow")
);
...
var Popper = __name12((props3) => {
  const { __scopePopper, children } = props3;
  const [anchor, setAnchor] = React13.useState(null);
  const [placementState, setPlacementState] = React13.useState(void 0);
...
var PopperAnchor = React13.forwardRef(
  __name12(function PopperAnchor2(props3, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props3;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React13.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React13.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
    ...
    return virtualRef ? null : (0, import_jsx_runtime6.jsx)(
      Primitive.div,
      {
...
var PopperContent = React13.forwardRef(
  __name12(function PopperContent2(props3, forwardedRef) {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name12((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name12(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React13.forwardRef(
  __name12(function PopperArrow2(props3, forwardedRef) {
...
__name12(isNotNull, "isNotNull");
var transformOrigin = __name12((options) => ({
...
__name12(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root22 = Popper;
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name13((event) => {
      ...
      const handleAnimationStart = __name13((event) => {
...
__name14(useEffectEvent, "useEffectEvent");
...
__name15(useControllableState, "useControllableState");
...
__name15(useUncontrolledState, "useUncontrolledState");
function isFunction(value) {
  return typeof value === "function";
}
__name15(isFunction, "isFunction");
...
__name15(useControllableStateReducer, "useControllableStateReducer");
...
var VisuallyHidden = React17.forwardRef(
  __name16(function VisuallyHidden2(props3, forwardedRef) {
    return (0, import_jsx_runtime7.jsx)(
      Primitive.span,
      {
        ...props3,
        ref: forwardedRef,
        style: { ...VISUALLY_HIDDEN_STYLES, ...props3.style }
      }
    );
  }, "VisuallyHidden")
);
...
var TooltipProvider = __name17((props3) => {
  const {
    __scopeTooltip,
...
var Tooltip = __name17((props3) => {
  ...
  const [contentIdState, setContentId] = React18.useState(void 0);
  ...
  return (0, import_jsx_runtime8.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime8.jsx)(
...
var TooltipTrigger = React18.forwardRef(
  __name17(function TooltipTrigger2(props3, forwardedRef) {
...
var TooltipPortal = __name17((props3) => {
...
var TooltipContent = React18.forwardRef(
  __name17(function TooltipContent2(props3, forwardedRef) {
...
var TooltipContentHoverable = React18.forwardRef(__name17(function TooltipContentHoverable2(props3, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props3.__scopeTooltip);
  ...
  React18.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name17((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name17((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React18.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name17((event) => {
        const target = event.target;
  ...
  return (0, import_jsx_runtime8.jsx)(TooltipContentImpl, { ...props3, ref: composedRefs });
}, "TooltipContentHoverable"));
var Slottable2 = createSlottable("TooltipContent");
var TooltipContentImpl = React18.forwardRef(
  // blank line to reduce diff noise
  __name17(function TooltipContentImpl2(props3, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React18.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name17((event) => {
        ...
        children: (0, import_jsx_runtime8.jsxs)(
          Content,
          {
            ...
            children: [
              ...
              ariaLabel ? (0, import_jsx_runtime8.jsx)(Root3, { id: context.contentId, role: "tooltip", children: ariaLabel }) : null
            ]
          }
        )
      }
...
var TooltipArrow = React18.forwardRef(
  __name17(function TooltipArrow2(props3, forwardedRef) {
    const { __scopeTooltip, ...arrowProps } = props3;
    const popperScope = usePopperScope(__scopeTooltip);
    return (0, import_jsx_runtime8.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }, "TooltipArrow")
);
...
__name17(getExitSideFromRect, "getExitSideFromRect");
...
__name17(getPaddedExitPoints, "getPaddedExitPoints");
...
__name17(getPointsFromRect, "getPointsFromRect");
...
__name17(isPointInPolygon, "isPointInPolygon");
...
__name17(getHullPresorted, "getHullPresorted");
...
function _objectWithoutPropertiesLoose(r4, e4) {
  ...
  for (var n4 in r4) if ({}.hasOwnProperty.call(r4, n4)) {
    if (-1 !== e4.indexOf(n4)) continue;
    t4[n4] = r4[n4];
  }
  return t4;
}
function _objectWithoutProperties(e4, t4) {
  if (null == e4) return {};
  var o4, r4, i4 = _objectWithoutPropertiesLoose(e4, t4);
  if (Object.getOwnPropertySymbols) {
    var n4 = Object.getOwnPropertySymbols(e4);
    for (r4 = 0; r4 < n4.length; r4++) o4 = n4[r4], -1 === t4.indexOf(o4) && {}.propertyIsEnumerable.call(e4, o4) && (i4[o4] = e4[o4]);
  }
  return i4;
}
var LevaErrors = (function(LevaErrors2) {
...
function _log(fn, errorType, ...args) {
  const errorFn = ErrorList[errorType];
  const [message, ...rest2] = errorFn(...args);
...
var parens = /\(([^\(\)]+)\)/;
var exp = /(-?\d+(?:\.\d+)?)\s*\^\s*(-?\d+(?:\.\d+)?)/;
var muldiv = /(-?\d+(?:\.\d+)?)\s*([*/])\s*(-?\d+(?:\.\d+)?)/;
var addsub = /(-?\d+(?:\.\d+)?)\s*([+-])\s*(-?\d+(?:\.\d+)?)/;
function evaluate2(expr) {
  expr = expr.replace(/\s+/g, "");
  if (parens.test(expr)) {
    return evaluate2(expr.replace(parens, (_2, subExpr) => evaluate2(subExpr).toString()));
  }
  if (exp.test(expr)) {
    return evaluate2(expr.replace(exp, (_2, a4, b4) => Math.pow(Number(a4), Number(b4)).toString()));
  }
  if (muldiv.test(expr)) {
    return evaluate2(expr.replace(muldiv, (_2, a4, op, b4) => op === "*" ? (Number(a4) * Number(b4)).toString() : Number(b4) === 0 ? (() => {
      throw new Error("Division by zero");
    })() : (Number(a4) / Number(b4)).toString()));
  }
  if (addsub.test(expr)) {
    return evaluate2(expr.replace(addsub, (_2, a4, op, b4) => op === "+" ? (Number(a4) + Number(b4)).toString() : (Number(a4) - Number(b4)).toString()));
  }
  return Number(expr);
}
...
var SpecialInputs = (function(SpecialInputs2) {
  ...
  return SpecialInputs2;
})({});
var LevaInputs = (function(LevaInputs2) {
...
function _extends() {
  return _extends = Object.assign ? Object.assign.bind() : function(n4) {
    for (var e4 = 1; e4 < arguments.length; e4++) {
      var t4 = arguments[e4];
      for (var r4 in t4) ({}).hasOwnProperty.call(t4, r4) && (n4[r4] = t4[r4]);
    }
    return n4;
...
stitches.css;
var createTheme = stitches.createTheme;
var globalCss = stitches.globalCss;
var keyframes = stitches.keyframes;
...
function ValueInput(_ref) {
  ...
  import_react3.default.useEffect(() => {
    ...
    ref === null || ref === void 0 || ref.addEventListener("blur", _onUpdate);
...
function Portal3({
  children,
  container = ((_globalThis$document) => globalThis === null || globalThis === void 0 || (_globalThis$document = globalThis.document) === null || _globalThis$document === void 0 ? void 0 : _globalThis$document.body)()
}) {
  const {
    className
  } = (0, import_react3.useContext)(ThemeContext);
...
function RawLabel(props3) {
  ...
  const htmlForProp = props3.htmlFor || (id ? id : void 0);
  const titleProp = !hint && typeof props3.children === "string" ? props3.children : void 0;
  return import_react3.default.createElement(import_react3.default.Fragment, null, optional2 && import_react3.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react3.default.createElement(Root32, null, import_react3.default.createElement(Trigger, {
    asChild: true
  }, import_react3.default.createElement(StyledLabel, _extends({
    htmlFor: htmlForProp
  }, props3))), import_react3.default.createElement(Content2, {
    side: "top",
    sideOffset: 2
  }, import_react3.default.createElement(StyledToolTipContent, null, hint, import_react3.default.createElement(ToolTipArrow, null)))) : import_react3.default.createElement(StyledLabel, _extends({
    htmlFor: htmlForProp,
    title: titleProp
  }, props3)));
}
...
function useDrag2(handler, config) {
  ...
  return useDrag((state) => {
    if (state.first) {
      ...
      emitOnEditStart === null || emitOnEditStart === void 0 || emitOnEditStart();
    }
    const result = handler(state);
    if (state.last) {
      document.body.classList.remove("leva__panel__dragged");
      emitOnEditEnd === null || emitOnEditEnd === void 0 || emitOnEditEnd();
    }
    return result;
  }, config);
}
...
function l3() {
  return (l3 = Object.assign || function(e4) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var n4 = arguments[r4];
      for (var t4 in n4) Object.prototype.hasOwnProperty.call(n4, t4) && (e4[t4] = n4[t4]);
    }
    return e4;
...
function c3(e4, r4) {
  if (null == e4) return {};
  var n4, t4, o4 = {}, a4 = Object.keys(e4);
  for (t4 = 0; t4 < a4.length; t4++) r4.indexOf(n4 = a4[t4]) >= 0 || (o4[n4] = e4[n4]);
  return o4;
}
function i3(e4) {
  var n4 = (0, import_react6.useRef)(e4), t4 = (0, import_react6.useRef)(function(e5) {
    n4.current && n4.current(e5);
  });
  return n4.current = e4, t4.current;
}
var s3 = function(e4, r4, n4) {
  return void 0 === r4 && (r4 = 0), void 0 === n4 && (n4 = 1), e4 > n4 ? n4 : e4 < r4 ? r4 : e4;
};
var f3 = function(e4) {
...
var v3 = function(e4, r4, n4) {
  var t4 = e4.getBoundingClientRect(), o4 = f3(r4) ? (function(e5, r5) {
    for (var n5 = 0; n5 < e5.length; n5++) if (e5[n5].identifier === r5) return e5[n5];
    return e5[0];
  })(r4.touches, n4) : r4;
  return { left: s3((o4.pageX - (t4.left + d3(e4).pageXOffset)) / t4.width), top: s3((o4.pageY - (t4.top + d3(e4).pageYOffset)) / t4.height) };
};
var h3 = function(e4) {
  !f3(e4) && e4.preventDefault();
};
var g3 = import_react6.default.memo(function(o4) {
  var a4 = o4.onMove, u4 = o4.onKey, s4 = o4.onEnd, g4 = c3(o4, ["onMove", "onKey", "onEnd"]), m4 = (0, import_react6.useRef)(null), p4 = i3(a4), b4 = i3(u4), _2 = i3(s4), E2 = (0, import_react6.useRef)(null), C2 = (0, import_react6.useRef)(false), x3 = (0, import_react6.useMemo)(function() {
    var e4 = function(e5) {
      h3(e5), (f3(e5) ? e5.touches.length > 0 : e5.buttons > 0) && m4.current ? p4(v3(m4.current, e5, E2.current)) : (n4(false), _2());
    }, r4 = function() {
      n4(false), _2();
    };
    function n4(n5) {
      var t4 = C2.current, o5 = d3(m4.current), a5 = n5 ? o5.addEventListener : o5.removeEventListener;
      a5(t4 ? "touchmove" : "mousemove", e4), a5(t4 ? "touchend" : "mouseup", r4);
    }
    return [function(e5) {
      var r5 = e5.nativeEvent, t4 = m4.current;
      if (t4 && (h3(r5), !(function(e6, r6) {
        return r6 && !f3(e6);
      })(r5, C2.current) && t4)) {
        if (f3(r5)) {
          C2.current = true;
          var o5 = r5.changedTouches || [];
          o5.length && (E2.current = o5[0].identifier);
        }
        t4.focus(), p4(v3(t4, r5, E2.current)), n4(true);
      }
    }, function(e5) {
      var r5 = e5.which || e5.keyCode;
      r5 < 37 || r5 > 40 || (e5.preventDefault(), b4({ left: 39 === r5 ? 0.05 : 37 === r5 ? -0.05 : 0, top: 40 === r5 ? 0.05 : 38 === r5 ? -0.05 : 0 }));
    }, function(e5) {
      var r5 = e5.which || e5.keyCode;
      r5 >= 37 && r5 <= 40 && _2();
    }, n4];
  }, [b4, p4, _2]), H3 = x3[0], M3 = x3[1], N3 = x3[2], w3 = x3[3];
  return (0, import_react6.useEffect)(function() {
    return w3;
  }, [w3]), import_react6.default.createElement("div", l3({}, g4, { onTouchStart: H3, onMouseDown: H3, className: "react-colorful__interactive", ref: m4, onKeyDown: M3, onKeyUp: N3, tabIndex: 0, role: "slider" }));
});
var m3 = function(e4) {
  return e4.filter(Boolean).join(" ");
};
var p3 = function(r4) {
  var n4 = r4.color, t4 = r4.left, o4 = r4.top, a4 = void 0 === o4 ? 0.5 : o4, u4 = m3(["react-colorful__pointer", r4.className]);
  return import_react6.default.createElement("div", { className: u4, style: { top: 100 * a4 + "%", left: 100 * t4 + "%" } }, import_react6.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: n4 } }));
};
var b3 = function(e4, r4, n4) {
  return void 0 === r4 && (r4 = 0), void 0 === n4 && (n4 = Math.pow(10, r4)), Math.round(n4 * e4) / n4;
};
var _ = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) };
var y3 = function(e4) {
  var r4 = e4.s, n4 = e4.v, t4 = e4.a, o4 = (200 - r4) * n4 / 100;
  return { h: b3(e4.h), s: b3(o4 > 0 && o4 < 200 ? r4 * n4 / 100 / (o4 <= 100 ? o4 : 200 - o4) * 100 : 0), l: b3(o4 / 2), a: b3(t4, 2) };
};
var k3 = function(e4) {
  var r4 = y3(e4);
...
var I3 = function(e4) {
  var r4 = e4.h, n4 = e4.s, t4 = e4.v, o4 = e4.a;
  r4 = r4 / 360 * 6, n4 /= 100, t4 /= 100;
  var a4 = Math.floor(r4), u4 = t4 * (1 - n4), l4 = t4 * (1 - (r4 - a4) * n4), c4 = t4 * (1 - (1 - r4 + a4) * n4), i4 = a4 % 6;
  return { r: b3(255 * [t4, l4, u4, u4, c4, t4][i4]), g: b3(255 * [c4, t4, t4, l4, u4, u4][i4]), b: b3(255 * [u4, u4, c4, t4, t4, l4][i4]), a: b3(o4, 2) };
};
var L2 = function(e4) {
  var r4 = e4.r, n4 = e4.g, t4 = e4.b, o4 = e4.a, a4 = Math.max(r4, n4, t4), u4 = a4 - Math.min(r4, n4, t4), l4 = u4 ? a4 === r4 ? (n4 - t4) / u4 : a4 === n4 ? 2 + (t4 - r4) / u4 : 4 + (r4 - n4) / u4 : 0;
  return { h: b3(60 * (l4 < 0 ? l4 + 6 : l4)), s: b3(a4 ? u4 / a4 * 100 : 0), v: b3(a4 / 255 * 100), a: o4 };
};
var R2 = import_react6.default.memo(function(r4) {
  var n4 = r4.hue, t4 = r4.onChange, o4 = r4.onChangeEnd, a4 = m3(["react-colorful__hue", r4.className]);
  return import_react6.default.createElement("div", { className: a4 }, import_react6.default.createElement(g3, { onMove: function(e4) {
    t4({ h: 360 * e4.left });
  }, onKey: function(e4) {
    t4({ h: s3(n4 + 360 * e4.left, 0, 360) });
  }, onEnd: o4, "aria-label": "Hue", "aria-valuenow": b3(n4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react6.default.createElement(p3, { className: "react-colorful__hue-pointer", left: n4 / 360, color: k3({ h: n4, s: 100, v: 100, a: 1 }) })));
});
var S3 = import_react6.default.memo(function(r4) {
  var n4 = r4.hsva, t4 = r4.onChange, o4 = r4.onChangeEnd, a4 = { backgroundColor: k3({ h: n4.h, s: 100, v: 100, a: 1 }) };
  return import_react6.default.createElement("div", { className: "react-colorful__saturation", style: a4 }, import_react6.default.createElement(g3, { onMove: function(e4) {
    t4({ s: 100 * e4.left, v: 100 - 100 * e4.top });
  }, onKey: function(e4) {
    t4({ s: s3(n4.s + 100 * e4.left, 0, 100), v: s3(n4.v - 100 * e4.top, 0, 100) });
  }, onEnd: o4, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(n4.s) + "%, Brightness " + b3(n4.v) + "%" }, import_react6.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - n4.v / 100, left: n4.s / 100, color: k3(n4) })));
});
var T2 = function(e4, r4) {
  if (e4 === r4) return true;
  for (var n4 in e4) if (e4[n4] !== r4[n4]) return false;
  return true;
};
function X(e4, n4, u4, l4) {
  var c4 = i3(u4), s4 = i3(l4), f4 = (0, import_react6.useState)(function() {
    return e4.toHsva(n4);
  }), d4 = f4[0], v4 = f4[1], h4 = (0, import_react6.useRef)({ color: n4, hsva: d4 }), g4 = (0, import_react6.useRef)(false);
  (0, import_react6.useEffect)(function() {
    if (!e4.equal(n4, h4.current.color)) {
      var r4 = e4.toHsva(n4);
      h4.current = { hsva: r4, color: n4 }, v4(r4), g4.current = false;
    }
  }, [n4, e4]), (0, import_react6.useEffect)(function() {
    var r4;
    T2(d4, h4.current.hsva) || e4.equal(r4 = e4.fromHsva(d4), h4.current.color) || (h4.current = { hsva: d4, color: r4 }, c4(r4), g4.current = true);
  }, [d4, e4, c4]);
  var m4 = (0, import_react6.useCallback)(function(e5) {
    v4(function(r4) {
      return Object.assign({}, r4, e5);
    });
  }, []), p4 = (0, import_react6.useCallback)(function() {
    g4.current && (g4.current = false, s4(h4.current.color));
  }, [s4]);
  return [d4, m4, p4];
}
var Y2;
var U2 = "undefined" != typeof window ? import_react6.useLayoutEffect : import_react6.useEffect;
var V2 = function() {
  return Y2 || ("undefined" != typeof __webpack_nonce__ ? __webpack_nonce__ : void 0);
};
var $3 = /* @__PURE__ */ new WeakMap();
var G2 = function(e4) {
  U2(function() {
    var r4 = e4.current;
    if ("undefined" != typeof document && r4) {
      var n4 = r4.getRootNode ? r4.getRootNode() : r4.ownerDocument, t4 = n4 && ("head" in n4 || "host" in n4) ? n4 : r4.ownerDocument;
      if (!$3.has(t4)) {
        var o4 = "head" in t4 ? t4.head : t4, a4 = (o4.ownerDocument || document).createElement("style");
        ...
        var u4 = V2();
        u4 && a4.setAttribute("nonce", u4), $3.set(t4, a4), o4.appendChild(a4);
      }
    }
  }, []);
};
var J2 = function(n4) {
  var t4 = n4.className, o4 = n4.colorModel, a4 = n4.color, u4 = void 0 === a4 ? o4.defaultColor : a4, i4 = n4.onChange, s4 = n4.onChangeEnd, f4 = c3(n4, ["className", "colorModel", "color", "onChange", "onChangeEnd"]), d4 = (0, import_react6.useRef)(null);
  G2(d4);
  var v4 = X(o4, u4, i4, s4), h4 = v4[0], g4 = v4[1], p4 = v4[2], b4 = m3(["react-colorful", t4]);
  return import_react6.default.createElement("div", l3({}, f4, { ref: d4, className: b4 }), import_react6.default.createElement(S3, { hsva: h4, onChange: g4, onChangeEnd: p4 }), import_react6.default.createElement(R2, { hue: h4.h, onChange: g4, onChangeEnd: p4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  var n4 = r4.className, t4 = r4.hsva, o4 = r4.onChange, a4 = r4.onChangeEnd, u4 = { backgroundImage: "linear-gradient(90deg, " + q2(Object.assign({}, t4, { a: 0 })) + ", " + q2(Object.assign({}, t4, { a: 1 })) + ")" }, l4 = m3(["react-colorful__alpha", n4]), c4 = b3(100 * t4.a);
  return import_react6.default.createElement("div", { className: l4 }, import_react6.default.createElement("div", { className: "react-colorful__alpha-gradient", style: u4 }), import_react6.default.createElement(g3, { onMove: function(e4) {
    o4({ a: e4.left });
  }, onKey: function(e4) {
    o4({ a: s3(t4.a + e4.left) });
  }, onEnd: a4, "aria-label": "Alpha", "aria-valuetext": c4 + "%", "aria-valuenow": c4, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react6.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: t4.a, color: q2(t4) })));
};
var re = function(n4) {
  var t4 = n4.className, o4 = n4.colorModel, a4 = n4.color, u4 = void 0 === a4 ? o4.defaultColor : a4, i4 = n4.onChange, s4 = n4.onChangeEnd, f4 = c3(n4, ["className", "colorModel", "color", "onChange", "onChangeEnd"]), d4 = (0, import_react6.useRef)(null);
  G2(d4);
  var v4 = X(o4, u4, i4, s4), h4 = v4[0], g4 = v4[1], p4 = v4[2], b4 = m3(["react-colorful", t4]);
  return import_react6.default.createElement("div", l3({}, f4, { ref: d4, className: b4 }), import_react6.default.createElement(S3, { hsva: h4, onChange: g4, onChangeEnd: p4 }), import_react6.default.createElement(R2, { hue: h4.h, onChange: g4, onChangeEnd: p4 }), import_react6.default.createElement(ee, { hsva: h4, onChange: g4, onChangeEnd: p4, className: "react-colorful__last-control" }));
};
var Ee = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: T2 };
var Ce = function(r4) {
  return import_react6.default.createElement(re, l3({}, r4, { colorModel: Ee }));
};
...
var Ne = function(r4) {
  return import_react6.default.createElement(J2, l3({}, r4, { colorModel: Me }));
};
...
function create(createState) {
  ...
  const useStore = (selector = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react8.useReducer)((c4) => c4 + 1, 0);
...
function useDeepMemo(fn, deps) {
  var _useCompareMemoize;
  return (0, import_react9.useMemo)(fn, (_useCompareMemoize = useCompareMemoize(deps, true)) !== null && _useCompareMemoize !== void 0 ? _useCompareMemoize : []);
}
function useToggle(toggled) {
  const wrapperRef = (0, import_react9.useRef)(null);
  const contentRef = (0, import_react9.useRef)(null);
  const firstRender = (0, import_react9.useRef)(true);
...
var useVisiblePaths = (store) => {
  const [paths, setPaths] = (0, import_react9.useState)(store.getVisiblePaths());
  (0, import_react9.useEffect)(() => {
...
function usePopin(margin = 3) {
  const popinRef = (0, import_react9.useRef)(null);
  const wrapperRef = (0, import_react9.useRef)(null);
  const [shown, setShow] = (0, import_react9.useState)(false);
  const show = (0, import_react9.useCallback)(() => setShow(true), []);
  const hide4 = (0, import_react9.useCallback)(() => setShow(false), []);
  (0, import_react9.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
...
function Color({
  ...
  const timer = (0, import_react9.useRef)(0);
  const [initialRgb, setInitialRgb] = (0, import_react9.useState)(() => convertToRgb(value, format3));
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(ColorPreview, {
    ref: popinRef,
    active: shown,
    onClick: () => showPicker(),
    style: {
  ...
  }), shown && import_react9.default.createElement(Portal3, null, import_react9.default.createElement(Overlay, {
    onPointerUp: hidePicker
  }), import_react9.default.createElement(PickerWrapper, {
    ref: wrapperRef,
    onMouseEnter: () => window.clearTimeout(timer.current),
    onMouseLeave: (e4) => e4.buttons === 0 && hideAfterDelay()
  }, import_react9.default.createElement(ColorPicker, {
    color: initialRgb,
    onChange: onUpdate
  }))));
}
function ColorComponent() {
  ...
  return import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(PickerContainer, null, import_react9.default.createElement(Color, {
    value,
    displayValue,
    onChange,
    onUpdate,
    settings
  }), import_react9.default.createElement(ValueInput, {
    value: displayValue,
    onChange,
    onUpdate
  })));
...
function Vector3dComponent() {
  ...
  return import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  }));
...
function Joystick({
  ...
  const timeout = (0, import_react9.useRef)();
  const outOfBoundsX = (0, import_react9.useRef)(0);
  const outOfBoundsY = (0, import_react9.useRef)(0);
  const stepMultiplier = (0, import_react9.useRef)(1);
  const [joystickShown, setShowJoystick] = (0, import_react9.useState)(false);
  const [isOutOfBounds, setIsOutOfBounds] = (0, import_react9.useState)(false);
  const [spanRef, set] = useTransform();
  const joystickeRef = (0, import_react9.useRef)(null);
  const playgroundRef = (0, import_react9.useRef)(null);
  (0, import_react9.useLayoutEffect)(() => {
    if (joystickShown) {
      const {
        top,
  ...
  const startOutOfBounds = (0, import_react9.useCallback)(() => {
  ...
  const endOutOfBounds = (0, import_react9.useCallback)(() => {
  ...
  return import_react9.default.createElement(JoystickTrigger, _extends({
    ref: joystickeRef
  }, bind()), joystickShown && import_react9.default.createElement(Portal3, null, import_react9.default.createElement(JoystickPlayground, {
    ref: playgroundRef,
    isOutOfBounds
  }, import_react9.default.createElement("div", null), import_react9.default.createElement("span", {
    ref: spanRef
  }))));
}
...
function Vector2dComponent() {
  ...
  return import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(Container$1, {
    withJoystick: !!settings.joystick
  }, settings.joystick && import_react9.default.createElement(Joystick, {
    value: displayValue,
    settings,
    onUpdate
  }), import_react9.default.createElement(Vector, {
    value: displayValue,
    settings,
    onUpdate
  })));
...
function ImageComponent() {
  ...
  const onDrop = (0, import_react9.useCallback)((acceptedFiles) => {
    if (acceptedFiles.length) onUpdate(acceptedFiles[0]);
  }, [onUpdate]);
  const clear = (0, import_react9.useCallback)((e4) => {
    e4.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
  ...
  return import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(ImageContainer, null, import_react9.default.createElement(ImagePreview, {
    ref: popinRef,
    hasImage: !!value,
  ...
  }), shown && !!value && import_react9.default.createElement(Portal3, null, import_react9.default.createElement(Overlay, {
    onPointerUp: hide4,
    style: {
      cursor: "pointer"
    }
  }), import_react9.default.createElement(ImageLargePreview, {
    ref: wrapperRef,
    style: {
      backgroundImage: `url(${value})`
    }
  })), import_react9.default.createElement(DropZone, getRootProps({
    isDragAccept
  }), import_react9.default.createElement("input", getInputProps()), import_react9.default.createElement(Instructions, null, isDragAccept ? "drop image" : "click or drop")), import_react9.default.createElement(Remove, {
    onClick: clear,
    disabled: !value
  })));
}
...
function IntervalSlider(_ref) {
  ...
  const minScrubberRef = (0, import_react9.useRef)(null);
  const maxScrubberRef = (0, import_react9.useRef)(null);
  const rangeWidth = (0, import_react9.useRef)(0);
  const scrubberWidth = useTh("sizes", "scrubberWidth");
  const bind = useDrag2(({
    event,
    first,
  ...
  return import_react9.default.createElement(RangeWrapper, _extends({
    ref
  }, bind()), import_react9.default.createElement(Range, null, import_react9.default.createElement(Indicator, {
    style: {
      left: minStyle,
      right: maxStyle
    }
  })), import_react9.default.createElement(Scrubber, {
    position: "left",
    ref: minScrubberRef,
    style: {
      left: minStyle
...
function IntervalComponent() {
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(Container2, null, import_react9.default.createElement(IntervalSlider, _extends({
    value: displayValue
  }, settings, {
    onDrag: onUpdate
  })), import_react9.default.createElement(Vector, {
...
var Store = function Store2() {
  ...
  this.getVisiblePaths = () => {
    ...
    Object.entries(folders).forEach(([path, settings]) => {
      if (settings.render && paths.some((p4) => p4.indexOf(path) === 0) && !settings.render(this.get)) hiddenFolders.push(path + ".");
    });
    const visiblePaths = [];
...
function useCreateStore() {
  return (0, import_react9.useMemo)(() => new Store(), []);
}
if (typeof window !== "undefined") {
...
function ControlInput(_ref) {
  ...
  return import_react9.default.createElement(InputContext.Provider, {
  ...
  }, import_react9.default.createElement(StyledInputWrapper$1, {
    disabled
  }, import_react9.default.createElement(Input, null)));
}
...
function Button({
  ...
  const store = useStoreContext();
  return import_react9.default.createElement(Row, null, import_react9.default.createElement(StyledButton, {
...
function ButtonGroup(props3) {
  ...
  return import_react9.default.createElement(Row, {
    input: !!label
  }, label && import_react9.default.createElement(Label, null, label), import_react9.default.createElement(StyledButtonGroup, null, Object.entries(opts).map(([label2, onClick]) => import_react9.default.createElement(StyledButtonGroupButton, {
    key: label2,
    onClick: () => onClick(store.get)
  }, label2))));
}
...
var MonitorCanvas = (0, import_react9.forwardRef)(function({
  initialValue
}, ref) {
  ...
  const [gradientTop, gradientBottom] = (0, import_react9.useMemo)(() => {
    return [w2(fillColor).alpha(0.4).toRgbString(), w2(fillColor).alpha(0.1).toRgbString()];
  }, [fillColor]);
  const points = (0, import_react9.useRef)([initialValue]);
  const min2 = (0, import_react9.useRef)(initialValue);
  const max2 = (0, import_react9.useRef)(initialValue);
  const raf = (0, import_react9.useRef)();
  const drawPlot = (0, import_react9.useCallback)((_canvas, _ctx) => {
    if (!_canvas) return;
    const {
      width,
      height
  ...
  (0, import_react9.useEffect)(() => () => cancelAnimationFrame(raf.current), []);
  return import_react9.default.createElement(Canvas, {
    ref: canvas
  });
});
var parse = (val) => Number.isFinite(val) ? val.toPrecision(2) : val.toString();
var MonitorLog = (0, import_react9.forwardRef)(function({
  initialValue
}, ref) {
  const [val, set] = (0, import_react9.useState)(parse(initialValue));
  (0, import_react9.useImperativeHandle)(ref, () => ({
    frame: (v4) => set(parse(v4))
  }), []);
  return import_react9.default.createElement("div", null, val);
});
...
function Monitor({
  ...
  const ref = (0, import_react9.useRef)();
  const initialValue = (0, import_react9.useRef)(getValue(objectOrFn));
  (0, import_react9.useEffect)(() => {
    const timeout = window.setInterval(() => {
      var _ref$current;
      if (document.hidden) return;
      (_ref$current = ref.current) === null || _ref$current === void 0 || _ref$current.frame(getValue(objectOrFn));
    }, settings.interval);
  ...
  return import_react9.default.createElement(Row, {
    ...
    align: "top"
  }, label), settings.graph ? import_react9.default.createElement(MonitorCanvas, {
    ref,
    initialValue: initialValue.current
  }) : import_react9.default.createElement(MonitorLog, {
    ref,
    initialValue: initialValue.current
  }));
}
...
var Control = import_react9.default.memo(({
  path
}) => {
  const [input, {
    set,
  ...
  if (type in SpecialInputs) {
    ...
    return import_react9.default.createElement(SpecialInputForType, _extends({
      label,
      path
    }, inputProps));
  }
  ...
  return import_react9.default.createElement(ControlInput, _extends({
    key: storeId + path,
    type,
    label,
    storeId,
...
function FolderTitle({
  ...
  return import_react9.default.createElement(StyledTitle, {
    onClick: () => toggle()
  }, import_react9.default.createElement(Chevron, {
    toggled
  }), import_react9.default.createElement("div", null, name));
}
var Folder = ({
  name,
  path,
  ...
  const [toggled, setToggle] = (0, import_react9.useState)(!collapsed);
  const folderRef = (0, import_react9.useRef)(null);
  ...
  return import_react9.default.createElement(StyledFolder, {
    ref: folderRef
  }, import_react9.default.createElement(FolderTitle, {
    name,
    toggled,
    toggle: () => setToggle((t4) => !t4)
  }), import_react9.default.createElement(TreeWrapper, {
    parent: newPath,
    tree,
    toggled
  }));
};
var TreeWrapper = import_react9.default.memo(({
  ...
  return import_react9.default.createElement(StyledWrapper, {
    ref: wrapperRef,
    isRoot: _isRoot,
    fill: _fill,
    flat: _flat
  }, import_react9.default.createElement(StyledContent, {
    ref: contentRef,
    isRoot: _isRoot,
    toggled
  }, entries.map(([key, value]) => isInput(value) ? import_react9.default.createElement(Control, {
    key: value.path,
    valueKey: value.valueKey,
    path: value.path
  }) : import_react9.default.createElement(Folder, {
    key,
    name: key,
    path: parent,
    tree: value
...
var FilterInput = import_react9.default.forwardRef(({
  setFilter,
  toggle
}, ref) => {
  const [value, set] = (0, import_react9.useState)("");
  const debouncedOnChange = (0, import_react9.useMemo)(() => debounce(setFilter, 250), [setFilter]);
  const clear = () => {
    setFilter("");
    set("");
  };
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(StyledFilterInput, {
    ref,
    value,
  ...
  }, import_react9.default.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    height: "14",
    width: "14",
    viewBox: "0 0 20 20",
...
function TitleWithFilter({
  ...
  const [filterShown, setShowFilter] = (0, import_react9.useState)(false);
  const inputRef = (0, import_react9.useRef)(null);
  (0, import_react9.useEffect)(() => {
    var _inputRef$current, _inputRef$current2;
    if (filterShown) (_inputRef$current = inputRef.current) === null || _inputRef$current === void 0 || _inputRef$current.focus();
    else (_inputRef$current2 = inputRef.current) === null || _inputRef$current2 === void 0 || _inputRef$current2.blur();
  }, [filterShown]);
  const bind = useDrag2(({
    offset: [x3, y4],
    first,
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(StyledTitleWithFilter, {
    ...
    width: 12,
    height: 8
  })), import_react9.default.createElement(TitleContainer, _extends({}, drag ? bind() : {}, {
    drag,
    filterEnabled
  }), title === void 0 && drag ? import_react9.default.createElement("svg", {
    width: "20",
    height: "10",
    viewBox: "0 0 28 14",
    xmlns: "http://www.w3.org/2000/svg"
    ...
    cy: "12",
    r: "2"
  })) : title), filterEnabled && import_react9.default.createElement(Icon, {
    active: filterShown,
    ...
    clipRule: "evenodd"
  })))), import_react9.default.createElement(FilterWrapper, {
    toggled: filterShown
  }, import_react9.default.createElement(FilterInput, {
    ref: inputRef,
    setFilter,
    toggle
  })));
...
function LevaRoot(_ref) {
  ...
  const computedSetToggle = (0, import_react9.useMemo)(() => {
  ...
  return import_react9.default.createElement(ThemeContext.Provider, {
    value: themeContext
  }, import_react9.default.createElement(LevaCore, _extends({
    store
  }, props3, {
...
var LevaCore = import_react9.default.memo(({
  store,
  rootClass,
  fill: _fill = false,
  flat: _flat = false,
  ...
  const tree = (0, import_react9.useMemo)(() => buildTree(paths, filter), [paths, filter]);
  ...
  globalStyles();
  return import_react9.default.createElement(Provider, null, import_react9.default.createElement(PanelSettingsContext.Provider, {
    value: {
      hideCopyButton: _hideCopyButton
    }
  }, import_react9.default.createElement(StyledRoot, {
    ref: rootRef,
    className: rootClass,
    fill: _fill,
    flat: _flat,
  ...
  }, _titleBar && import_react9.default.createElement(TitleWithFilter, {
    onDrag: (point) => {
      set(point);
      onDrag === null || onDrag === void 0 || onDrag(point);
    },
    ...
    filterEnabled,
    from: position
  }), shouldShow && import_react9.default.createElement(StoreContext.Provider, {
    value: store
  }, import_react9.default.createElement(TreeWrapper, {
    isRoot: true,
    fill: _fill,
...
function Leva(_ref) {
  ...
  return import_react9.default.createElement(LevaRoot, _extends({
    store: levaStore
  }, props3));
}
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          (0, import_client.createRoot)(rootEl).render(import_react9.default.createElement(Leva, {
            isRoot: true
          }));
        }
      }
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  const depsChanged = (0, import_react9.useRef)(false);
  const firstRender = (0, import_react9.useRef)(true);
  ...
  const [store] = (0, import_react9.useState)(() => (hookSettings === null || hookSettings === void 0 ? void 0 : hookSettings.store) || levaStore);
  const [initialData, mappedPaths] = (0, import_react9.useMemo)(() => store.getDataFromSchema(_schema), [store, _schema]);
  const [allPaths, renderPaths, onChangePaths, onEditStartPaths, onEditEndPaths] = (0, import_react9.useMemo)(() => {
    const allPaths2 = [];
    const renderPaths2 = [];
  ...
  const paths = (0, import_react9.useMemo)(() => store.orderPaths(allPaths), [allPaths, store]);
  const values = useValuesForPath(store, renderPaths, initialData);
  const set = (0, import_react9.useCallback)((values2) => {
    const _values = Object.entries(values2).reduce((acc, [p4, v4]) => Object.assign(acc, {
      [mappedPaths[p4].path]: v4
    }), {});
    store.set(_values, false);
  }, [store, mappedPaths]);
  const get = (0, import_react9.useCallback)((path) => store.get(mappedPaths[path].path), [store, mappedPaths]);
  (0, import_react9.useEffect)(() => {
